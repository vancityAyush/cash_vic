...
class EditBankDetailsView extends GetView<BankController> {
  Bank bank;
  EditBankDetailsView({required this.bank});
  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => BankController());
    controller.UpdateBankDetails(bank);
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: controller.currentAccountNumber.value,
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: controller.currentIfsc.value,
                        // controller: controller.mobileTextEditingController,
                        // inputFormatters: [LengthLimitingTextInputFormatter(10)],
                        keyboardType: TextInputType.number,
                        cursorColor: Theme.of(context).primaryColor,
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: controller.currentAccountName.value,
                        // controller: controller.mobileTextEditingController,
                        // inputFormatters: [LengthLimitingTextInputFormatter(10)],
                        keyboardType: TextInputType.number,
                        cursorColor: Theme.of(context).primaryColor,
                    ...
                    Container(
                      ...
                      onTap: () async {
                        controller.saveBank(bankId: bank.id);
                        // Get.to(HomeView());
                      },
                      child: Container(
